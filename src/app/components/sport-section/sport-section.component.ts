...
export class SportSectionComponent {
  ...
  descriptionResult = [
    [
      // 1/11
      'Voyage en itinérance à vélo afin de parcourir la France d\'Est en Ouest. Départ dans les Vosges depuis Saint-Dié-des-Vosges et destination Brest. J\'ai voyagé avec un ami et nous sommes partis super léger avec très peu d\'affaires (sans tente, que à la belle étoile ou accueillis chez des personnes rencontrées sur la route :)). Nous avons parcouru au total 1100km et fait 7000m D+ sur un total de 7 jours ! A la fin kouign-amann en récompense :)',
      // 2/11
      'Voyage en itinérance à vélo pour rejoindre les Alpes depuis les Vosges. Départ depuis Saint-Dié-des-Vosges à destination de Moutiers, au pied du Parc National de la Vanoise dans les Alpes. De nombreux cols sur le chemin. Itinéraire qui passe par la France, la Suisse et l\'Italie et qui finit sur le col de la Loze ! Nous avons parcouru au total 550km pour 10 000m D+.',
      // 3/11
      'Voyage à vélo pour faire le tour du Massif des Vosges. Au programme: col de la Schlucht, planche des Belles Filles, col du Calvaire, col de Lauvy etc. Tout ca sur 3/4 jours avec juste un sac de couchage dans le dos pour dormir à la belle étoile aux sommets. Voyage avec un ami. ',
      // 4/11
      'Randonnée de 4 jours dans le massif du Juras, sur le GR5 (sur un morceau de Grandes Traversées du Juras) avec 2 amis sur une centaine de km. Dégustation de comté tout au long du chemin dans toutes les fermes rencontrées.',
      // 5/11
      'Randonnée de 4 jours dans le Vercors. Départ depuis Pont-en-Royans à destination de Luc-en-Diois. Jolis paysages constitués de vignes et de champs de lavande :)',
      // 6/11
      'Randonnée de 3 jours sur les traces du GR5 dans les Vosges. Randonnée en été et nuit en hamac pour changer de la tente. Ce chemin de randonnée est le plus fait dans les Vosges mais un des plus beaux.',
      // 7/11
      ...
      // 8/11
      'Randonnée de 5/6 jours en itinérance (on a quelques fois été accueillis chez des habitants). Avec deux amis, nous avons plus ou moins suivi les traces du GR21, l\'un des plus beaux GR que j\'ai fait. Départ depuis Dieppe à destination du Havre. Magnifiques points de vues sur les falaises de Normandie en passant par Etretat',
      // 9/11
      ...
      // 10/11
      'Parmi mes sorties à vélo, j\'essaie au maximum de faire des cols pour un maximum de difficulté. Ici, col de l\'Izoard lors d\'une sortie autour de la ville de Briançon à côté du massif des Ecrins.',
      // 11/11
      'Photo lors d\'une sortie dans le massif des Ecrins (département Hautes-Alpes) avec notamment une montée au pré de Madame Carles. Sortie où il est possible d\'apercevoir le glacier blanc, le glacier noir et le lac de l\'Eychauda.'
    ],
    [
      // 1/11
